...
public class ItemHandlerTest {
    ...
    public void getAllItemsTest() {
        webTestClient.get().uri(ITEM_FUNCTIONAL_V1_ENDPOINT)
    ...
    public void getAllItemsTest_1() {
        Flux<Item> itemsFlux = webTestClient.get().uri(ITEM_FUNCTIONAL_V1_ENDPOINT)
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getItemByIdTest() {
        webTestClient.get().uri(ITEM_FUNCTIONAL_V1_ENDPOINT+ "/{id}", "123")
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void saveItemTest() {
        ...
        webTestClient.post().uri(ITEM_FUNCTIONAL_V1_ENDPOINT)
                .accept(MediaType.APPLICATION_JSON)
    ...
    public void deleteItemTest() {
        webTestClient.delete().uri(ITEM_FUNCTIONAL_V1_ENDPOINT+ "/{id}", "123")
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isOk()
    ...
    public void updateItemTest() {
        ...
        webTestClient.put().uri(ITEM_FUNCTIONAL_V1_ENDPOINT+ "/{id}", "123")
    ...
    public void updateItemNotFoundTest() {
        ...
        webTestClient.put().uri(ITEM_FUNCTIONAL_V1_ENDPOINT + "/{id}", "554654")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
