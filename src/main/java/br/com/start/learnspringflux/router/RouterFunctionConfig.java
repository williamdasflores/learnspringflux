...
import br.com.start.learnspringflux.handler.HandlerFunction;
...
public class RouterFunctionConfig {
    ...
    public RouterFunction<ServerResponse> route(HandlerFunction handlerFunction) {
        return RouterFunctions.route(GET("/flux/functional")
                .and(accept(MediaType.APPLICATION_JSON)), handlerFunction::flux)
                .andRoute(GET("/mono/functional").and(accept(MediaType.APPLICATION_JSON)),
